...
if __name__ == '__main__':
    deprueba1 = Polinomio()
    deprueba1.agregar_termino(3, 2)
    deprueba1.agregar_termino(-2, 5)

    deprueba2 = Polinomio()
    deprueba2.agregar_termino(3, 7)
    deprueba2.agregar_termino(2, 3)

    print(deprueba1.mostrar())
    print(deprueba2.mostrar())
    print(deprueba1.obtener_valor(5))
    print(deprueba2.obtener_valor(3))
    ...
    deprueba5 = Polinomio.restar(deprueba1, deprueba2)
